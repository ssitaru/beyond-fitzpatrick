...
fin = "out.generated.lab.csv"
fout = "out.generated.fixedv3.csv"
...
for line in csvin:
    ...
    outcsv.writerow({'id': line['id'], 'hex_arm': line['hex_arm'], 'l_arm': line['l_arm'], 'a_arm': line['a_arm'], 'b_arm': line['b_arm'], 'ita_arm': ita_arm,
                     'hex_face': line['hex_face'], 'l_face': l_face, 'a_face': line['a_face'], 'b_face': line['b_face'], 'ita_face': ita_face})
